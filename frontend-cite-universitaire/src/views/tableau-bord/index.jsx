    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{statistiques?.totalEtudiant || 0}</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{statistiques?.totalChambre || 0}</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{statistiques?.totalReclamation || 0}</div>
            <p className="text-xs text-gray-500 mt-1">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold">{statistiques?.totalSanction || 0}</div>
          </CardContent>
        </Card>
      </div>
            ...
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  ...
                  dataKey="count"
                >
                  {(statistiques?.reclamationsParPriorite || []).map((entry, index) => (
        ...
        <CardContent>
          <div className="space-y-4">
            {(statistiques?.reclamationsRecentes || []).map((reclamation) => (
              <div key={reclamation.IdRec} className="flex items-center justify-between border-b pb-2">
            ...
            {(!statistiques?.reclamationsRecentes || statistiques?.reclamationsRecentes.length === 0) && (
